...
//Code mostly unchanged from  http://www.adammil.net/blog/v125_roguelike_vision_algorithms.html#mine
sealed class AdamMilVisibility : Visibility {
  ...
  bool BlocksLight(uint x, uint y, uint octant, Vector3Int origin) {
    ...
    return MapManager.Get.ObstacleMap.HasTile(new Vector3Int((int)nx, (int)ny, 0));
  }
